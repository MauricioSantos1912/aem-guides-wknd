...
(function(document, $) {
    ...
    function compareVersionCallback(currentPath, versionId, redirectTo, success) {
        if (success) {
            ...
            var errorMessage;
            if (redirectTo.responseText) {
                errorMessage = Granite.I18n.get(redirectTo.responseText);
            } else {
                errorMessage = Granite.I18n.get("Failed to compare version");
            }
            ui.alert(Granite.I18n.get("Preview"), errorMessage, "error");
        }
    }
