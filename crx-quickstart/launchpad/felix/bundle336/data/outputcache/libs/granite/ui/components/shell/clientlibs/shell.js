...
(function(window, document, $) {
    ...
    $(document).on("click", ".globalnav-toggle", function(e) {
        ...
        if (!Granite.UI.Foundation.XSS.isSameOrigin(url)) {
            return;
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                var sanitizedData = Granite.UI.Foundation.XSS.sanitizeHtml(data);
                var menu = $(sanitizedData).get(0);
                var $menu = $(menu);
...
(function(document, Coral, $) {
    ...
    var openOnBoarding = function() {
        ...
        if (!url || !Granite.UI.Foundation.XSS.isSameOrigin(url)) {
            return;
        }
